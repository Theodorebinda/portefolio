...
export default function LinkMediaSocial({currentTheme = 'string', className = 'string'}) {
    return (
        <Container className= {`${className} flex items-center justify-end gap-10 px-4 animate`}>
