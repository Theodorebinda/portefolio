      ...
      <Container className="flex-col flex md:flex-row justify-between mb-10 gap-10 md:gap-0 md:mb-8">
        <Container className="flex  flex-col gap-2">
          <Container className=" flex items-start md:items-center justify-start gap-4">
            {loading ? (
              <Skeleton className="w-[80px] h-[80px] bg-slate-300 rounded-full lg:flex z-[-10]" />
            ) : (
              <Image
                ...
                width={80}
                alt="theodore"
                className="object-cover rounded-full lg:flex"
                loading="lazy"
            ...
            <Typography className=" font-normal text-4xl lg:text-7xl">
              Je concois
            </Typography>
          </Container>

          <Typography className="lg:text-6xl text-4xl  font-bold  ">
            des applications
          </Typography>
